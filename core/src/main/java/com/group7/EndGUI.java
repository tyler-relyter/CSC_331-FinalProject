...
/**
 * An end menu screen that displays the end message, play again button, and an exit button.
 */
public class EndGUI implements Screen {
    ...
    public void show() {
        ...
        Label title = new Label("Thanks For Playing!", labelStyle);
        ...
        TextButton playButton = new TextButton("Play Again", buttonStyle);
